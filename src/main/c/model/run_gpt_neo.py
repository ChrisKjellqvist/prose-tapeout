...
if __name__ == "__main__":
    ...
    for i, layer in enumerate(model.transformer.h):
        ...
        save_tensor(alt, dirname, f"{layer_name}_ln_1_gb", i)
        ...
        save_tensor_spl(layer.attn.attention.k_proj.weight, 12, 64, dirname, f"{layer_name}_attn_kproj_weight", i)
        save_tensor_spl(layer.attn.attention.v_proj.weight, 12, 64, dirname, f"{layer_name}_attn_vproj_weight", i)
